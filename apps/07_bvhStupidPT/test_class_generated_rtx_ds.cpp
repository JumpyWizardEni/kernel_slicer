...
void TestClass_Generated_RTX::AllocateAllDescriptorSets()
{
  // allocate pool
  //
  VkDescriptorPoolSize buffersSize;
  buffersSize.type            = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
  buffersSize.descriptorCount = 9*4 + 10; // mul 4 and add 10 because of AMD bug
...
void TestClass_Generated_RTX::InitAllGeneratedDescriptorSets_StupidPathTrace()
{
  ...
  //
  // descriptor set #0: InitAccumDataCmd (["accumColor","accumThoroughput","threadFlags"])
  {
    std::vector<VkDescriptorBufferInfo> descriptorBufferInfo(3+1);
    std::vector<VkWriteDescriptorSet>   writeDescriptorSet(3+1);

    descriptorBufferInfo[0]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[0].buffer = StupidPathTrace_local.accumColorBuffer;
    descriptorBufferInfo[0].offset = StupidPathTrace_local.accumColorOffset;
    ...
    descriptorBufferInfo[1].buffer = StupidPathTrace_local.accumThoroughputBuffer;
    descriptorBufferInfo[1].offset = StupidPathTrace_local.accumThoroughputOffset;
    ...
    descriptorBufferInfo[2].buffer = StupidPathTrace_local.threadFlagsBuffer;
    descriptorBufferInfo[2].offset = StupidPathTrace_local.threadFlagsOffset;
  ...
  // descriptor set #1: InitEyeRayCmd (["in_pakedXY","rayPosAndNear","rayDirAndFar","threadFlags"])
  {
    std::vector<VkDescriptorBufferInfo> descriptorBufferInfo(4+1);
    std::vector<VkWriteDescriptorSet>   writeDescriptorSet(4+1);
    ...
    descriptorBufferInfo[1]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[1].buffer = StupidPathTrace_local.rayPosAndNearBuffer;
    descriptorBufferInfo[1].offset = StupidPathTrace_local.rayPosAndNearOffset;
    descriptorBufferInfo[1].range  = VK_WHOLE_SIZE;  
    ...
    descriptorBufferInfo[2]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[2].buffer = StupidPathTrace_local.rayDirAndFarBuffer;
    descriptorBufferInfo[2].offset = StupidPathTrace_local.rayDirAndFarOffset;
    descriptorBufferInfo[2].range  = VK_WHOLE_SIZE;  
    ...
    descriptorBufferInfo[3]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[3].buffer = StupidPathTrace_local.threadFlagsBuffer;
    descriptorBufferInfo[3].offset = StupidPathTrace_local.threadFlagsOffset;
    descriptorBufferInfo[3].range  = VK_WHOLE_SIZE;  
  ...
  // descriptor set #2: RayTraceCmd (["rayPosAndNear","rayDirAndFar","hit","m_indicesReordered.data()","m_vPos4f.data()","threadFlags","m_intervals","m_nodes"])
  {
    std::vector<VkDescriptorBufferInfo> descriptorBufferInfo(8+1);
    std::vector<VkWriteDescriptorSet>   writeDescriptorSet(8+1);

    descriptorBufferInfo[0]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[0].buffer = StupidPathTrace_local.rayPosAndNearBuffer;
    descriptorBufferInfo[0].offset = StupidPathTrace_local.rayPosAndNearOffset;
    descriptorBufferInfo[0].range  = VK_WHOLE_SIZE;  
    ...
    descriptorBufferInfo[1]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[1].buffer = StupidPathTrace_local.rayDirAndFarBuffer;
    descriptorBufferInfo[1].offset = StupidPathTrace_local.rayDirAndFarOffset;
    descriptorBufferInfo[1].range  = VK_WHOLE_SIZE;  
    ...
    descriptorBufferInfo[2]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[2].buffer = StupidPathTrace_local.hitBuffer;
    descriptorBufferInfo[2].offset = StupidPathTrace_local.hitOffset;
    descriptorBufferInfo[2].range  = VK_WHOLE_SIZE;  
    ...
    descriptorBufferInfo[3]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[3].buffer = m_vdata.m_indicesReorderedBuffer;
    descriptorBufferInfo[3].offset = m_vdata.m_indicesReorderedOffset;
    descriptorBufferInfo[3].range  = VK_WHOLE_SIZE;  
    ...
    descriptorBufferInfo[4]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[4].buffer = m_vdata.m_vPos4fBuffer;
    descriptorBufferInfo[4].offset = m_vdata.m_vPos4fOffset;
    descriptorBufferInfo[4].range  = VK_WHOLE_SIZE;  
    ...
    descriptorBufferInfo[5].buffer = StupidPathTrace_local.threadFlagsBuffer;
    descriptorBufferInfo[5].offset = StupidPathTrace_local.threadFlagsOffset;
    ...
    descriptorBufferInfo[6].buffer = m_vdata.m_intervalsBuffer;
    descriptorBufferInfo[6].offset = m_vdata.m_intervalsOffset;
    ...
    descriptorBufferInfo[7].buffer = m_vdata.m_nodesBuffer;
    descriptorBufferInfo[7].offset = m_vdata.m_nodesOffset;
  ...
  // descriptor set #3: NextBounceCmd (["hit","rayPosAndNear","rayDirAndFar","accumColor","accumThoroughput","threadFlags","m_randomGens","m_vNorm4f","spheresMaterials"])
  {
    std::vector<VkDescriptorBufferInfo> descriptorBufferInfo(9+1);
    std::vector<VkWriteDescriptorSet>   writeDescriptorSet(9+1);

    descriptorBufferInfo[0]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[0].buffer = StupidPathTrace_local.hitBuffer;
    descriptorBufferInfo[0].offset = StupidPathTrace_local.hitOffset;
    descriptorBufferInfo[0].range  = VK_WHOLE_SIZE;  
    ...
    descriptorBufferInfo[3]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[3].buffer = StupidPathTrace_local.accumColorBuffer;
    descriptorBufferInfo[3].offset = StupidPathTrace_local.accumColorOffset;
    descriptorBufferInfo[3].range  = VK_WHOLE_SIZE;  
    ...
    descriptorBufferInfo[4]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[4].buffer = StupidPathTrace_local.accumThoroughputBuffer;
    descriptorBufferInfo[4].offset = StupidPathTrace_local.accumThoroughputOffset;
    descriptorBufferInfo[4].range  = VK_WHOLE_SIZE;  
    ...
    descriptorBufferInfo[6]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[6].buffer = m_vdata.m_randomGensBuffer;
    descriptorBufferInfo[6].offset = m_vdata.m_randomGensOffset;
    descriptorBufferInfo[6].range  = VK_WHOLE_SIZE;  
    ...
    descriptorBufferInfo[8]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[8].buffer = m_vdata.spheresMaterialsBuffer;
    descriptorBufferInfo[8].offset = m_vdata.spheresMaterialsOffset;
    descriptorBufferInfo[8].range  = VK_WHOLE_SIZE;  
  ...
  // descriptor set #4: ContributeToImageCmd (["accumColor","in_pakedXY","out_color","threadFlags"])
  {
    ...
    descriptorBufferInfo[1]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[1].buffer = StupidPathTrace_local.in_pakedXYBuffer;
    descriptorBufferInfo[1].offset = StupidPathTrace_local.in_pakedXYOffset;
    descriptorBufferInfo[1].range  = VK_WHOLE_SIZE;  
    ...
    descriptorBufferInfo[2]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[2].buffer = StupidPathTrace_local.out_colorBuffer;
    descriptorBufferInfo[2].offset = StupidPathTrace_local.out_colorOffset;
    descriptorBufferInfo[2].range  = VK_WHOLE_SIZE;  
...
void TestClass_Generated_RTX::InitAllGeneratedDescriptorSets_CastSingleRay()
{
  // now create actual bindings
  //
  ...
  // descriptor set #6: RayTraceCmd (["rayPosAndNear","rayDirAndFar","hit","m_indicesReordered.data()","m_vPos4f.data()","threadFlags","m_intervals","m_nodes"])
  {
    ...
    descriptorBufferInfo[5]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[5].buffer = CastSingleRay_local.threadFlagsBuffer;
    descriptorBufferInfo[5].offset = CastSingleRay_local.threadFlagsOffset;
    descriptorBufferInfo[5].range  = VK_WHOLE_SIZE;  
  ...
  // descriptor set #7: GetMaterialColorCmd (["hit","out_color","threadFlags","spheresMaterials"])
  {
    std::vector<VkDescriptorBufferInfo> descriptorBufferInfo(4+1);
    std::vector<VkWriteDescriptorSet>   writeDescriptorSet(4+1);
    ...
    descriptorBufferInfo[2]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[2].buffer = CastSingleRay_local.threadFlagsBuffer;
    descriptorBufferInfo[2].offset = CastSingleRay_local.threadFlagsOffset;
    descriptorBufferInfo[2].range  = VK_WHOLE_SIZE;  
...
void TestClass_Generated_RTX::InitAllGeneratedDescriptorSets_PackXY()
{
  // now create actual bindings
  //
  // descriptor set #8: PackXYCmd (["out_pakedXY"])
  {
    std::vector<VkDescriptorBufferInfo> descriptorBufferInfo(1+1);
    std::vector<VkWriteDescriptorSet>   writeDescriptorSet(1+1);
